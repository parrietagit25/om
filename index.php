                ...
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            <!-- Product image-->
                            <img class="card-img-top" src="<?php echo $value['photo']; ?>" alt="..." width="450" height="300" />
                            <!-- Product details-->
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="detalles.php?producto=<?php echo $value['id']; ?>">Ver detalles</a></div>
                            </div>
                        </div>
                    </div>
                    <?php } ?>
